describe('PUT /api/users/:id', () => {
    ...
    context('Atualização', () => {
        ...
        before(() => {
            ...
            cy.task('deleteUser', updatelUser.email)
        ...
        it('Deve atualizar um usuário existente', () => {
            cy.putUser(userId, updatelUser).then(response => {
        ...
        after(() => {
            cy.getUsers().then(response => {
                ...
                expect(spider.name).to.eq(updatelUser.name)
                expect(spider.email).to.eq(updatelUser.email)
            })
        })
    })
